...
Amazon Ads CLI & Skills for AI agents (and humans). Manage Sponsored Products, Brands, Display, and DSP campaigns across marketplaces, generate async reports, configure brand safety, and more.
...
> Install this CLI and skills from https://github.com/Bin-Huang/amazon-ads-open-cli
